...
public class BrowserGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ProgramElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Program");
	...
	public class LinesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Lines");
		...
		private final RuleCall cFindPropertyParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final RuleCall cFindFirstPropertyParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cFindSecondPropertyParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		private final RuleCall cGetTitleParserRuleCall_6 = (RuleCall)cAlternatives.eContents().get(6);
		...
		//FindProperty
		public RuleCall getFindPropertyParserRuleCall_3() { return cFindPropertyParserRuleCall_3; }
		
		//FindFirstProperty
		public RuleCall getFindFirstPropertyParserRuleCall_4() { return cFindFirstPropertyParserRuleCall_4; }
		
		//FindSecondProperty
		public RuleCall getFindSecondPropertyParserRuleCall_5() { return cFindSecondPropertyParserRuleCall_5; }
		
		//GetTitle
		public RuleCall getGetTitleParserRuleCall_6() { return cGetTitleParserRuleCall_6; }
	}
	public class FunctionCallElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.FunctionCall");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class DeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Declaration");
	...
	public class TypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Type");
	...
	public class AffectationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Affectation");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Expression");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class WebDriverTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.WebDriverType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class VarReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.VarReference");
	...
	public class WebElementVarReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.WebElementVarReference");
	...
	public class WebDriverVarReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.WebDriverVarReference");
		private final RuleCall cVarReferenceParserRuleCall = (RuleCall)rule.eContents().get(1);
	...
	public class VariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Variable");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class WebElementTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.WebElementType");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class LinkElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Link");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class InputElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Input");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ButtonElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Button");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TextElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Text");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CheckboxElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Checkbox");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ComboboxElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Combobox");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ListValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.ListValue");
	...
	public class ImageElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Image");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class GoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Go");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ContainsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Contains");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class InterractionsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Interractions");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		...
		private final RuleCall cCheckCheckboxParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		private final RuleCall cClearCheckboxParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		private final RuleCall cSelectComboboxParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		...
		//CheckCheckbox
		public RuleCall getCheckCheckboxParserRuleCall_2() { return cCheckCheckboxParserRuleCall_2; }
		
		//ClearCheckbox
		public RuleCall getClearCheckboxParserRuleCall_3() { return cClearCheckboxParserRuleCall_3; }
		
		//SelectCombobox
		public RuleCall getSelectComboboxParserRuleCall_4() { return cSelectComboboxParserRuleCall_4; }
	}
	public class ClickElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Click");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebElementVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
	...
	public class FindPropertyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.FindProperty");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebDriverVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
		private final Keyword cFindElementByKeyword_1 = (Keyword)cGroup.eContents().get(1);
		...
		//'.findElement(By.'
		public Keyword getFindElementByKeyword_1() { return cFindElementByKeyword_1; }
	...
	public class FindFirstPropertyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.FindFirstProperty");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebDriverVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
		private final Keyword cFindFirstElementByKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cNameAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cNameIDTerminalRuleCall_2_0 = (RuleCall)cNameAssignment_2.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cParamAssignment_4 = (Assignment)cGroup.eContents().get(4);
		...
		//'.findFirstElement(By.'
		public Keyword getFindFirstElementByKeyword_1() { return cFindFirstElementByKeyword_1; }
	...
	public class FindSecondPropertyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.FindSecondProperty");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebDriverVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
		private final Keyword cFindSecondElementByKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cNameAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cNameIDTerminalRuleCall_2_0 = (RuleCall)cNameAssignment_2.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cParamAssignment_4 = (Assignment)cGroup.eContents().get(4);
		...
		public Keyword getFindSecondElementByKeyword_1() { return cFindSecondElementByKeyword_1; }
	...
	public class GetTitleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.GetTitle");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebElementVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
	...
	public class InsertElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.Insert");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebElementVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
	...
	public class CheckCheckboxElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.CheckCheckbox");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebElementVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
	...
	public class ClearCheckboxElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.ClearCheckbox");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebDriverVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
	...
	public class SelectComboboxElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.SelectCombobox");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValWebElementVarReferenceParserRuleCall_0_0 = (RuleCall)cValAssignment_0.eContents().get(0);
	...
	public BrowserGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tPROTOCOL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.PROTOCOL");
		this.tEXTENTION = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.EXTENTION");
		this.tDOMAIN = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.DOMAIN");
		this.tPATH = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.PATH");
		this.tURL = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.Browser.URL");
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("org.xtext.example.mydsl.Browser".equals(grammar.getName())) {
				return grammar;
			}
