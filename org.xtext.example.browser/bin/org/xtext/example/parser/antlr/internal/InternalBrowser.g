...
@after {
	...
	(
		...
		{
			$current = $this_CheckContainsLink_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_CheckContainsText_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_FindProperty_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_FindFirstProperty_6.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_FindSecondProperty_7.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_GetTitle_8.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
@after {
	...
	(
		...
		{
			$current = $this_ReadElement_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_CheckCheckbox_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ClearCheckbox_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_SelectCombobox_5.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleReadElement returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getReadElementRule()); }
	iv_ruleReadElement=ruleReadElement
	{ $current=$iv_ruleReadElement.current; }
	EOF;

// Rule ReadElement
ruleReadElement returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleCheckContainsLink returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCheckContainsLinkRule()); }
	iv_ruleCheckContainsLink=ruleCheckContainsLink
	{ $current=$iv_ruleCheckContainsLink.current; }
	EOF;

// Rule CheckContainsLink
ruleCheckContainsLink returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		otherlv_1='.checkContainsLink(By.'
		{
...
entryRuleCheckContainsText returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCheckContainsTextRule()); }
	iv_ruleCheckContainsText=ruleCheckContainsText
	{ $current=$iv_ruleCheckContainsText.current; }
	EOF;

// Rule CheckContainsText
ruleCheckContainsText returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		otherlv_1='.checkContainsText(By.'
		{
...
@after {
	...
	(
		...
		otherlv_3='.findSecondElement(By.'
		{
