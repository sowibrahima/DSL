...
public class BrowserSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == BrowserPackage.eINSTANCE)
			...
			case BrowserPackage.CHECK_CONTAINS_LINK:
				sequence_CheckContainsLink(context, (CheckContainsLink) semanticObject); 
				return; 
			case BrowserPackage.CHECK_CONTAINS_TEXT:
				sequence_CheckContainsText(context, (CheckContainsText) semanticObject); 
				return; 
			...
			case BrowserPackage.READ_ELEMENT:
				sequence_ReadElement(context, (ReadElement) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     Lines returns CheckContainsLink
	 *     CheckContainsLink returns CheckContainsLink
	 *
	 * Constraint:
	 *     (val=WebDriverVarReference name=ID param=STRING)
	 */
	protected void sequence_CheckContainsLink(ISerializationContext context, CheckContainsLink semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_LINK__VAL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_LINK__VAL));
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_LINK__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_LINK__NAME));
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_LINK__PARAM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_LINK__PARAM));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getCheckContainsLinkAccess().getValWebDriverVarReferenceParserRuleCall_0_0(), semanticObject.getVal());
		feeder.accept(grammarAccess.getCheckContainsLinkAccess().getNameIDTerminalRuleCall_2_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getCheckContainsLinkAccess().getParamSTRINGTerminalRuleCall_4_0(), semanticObject.getParam());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     Lines returns CheckContainsText
	 *     CheckContainsText returns CheckContainsText
	 *
	 * Constraint:
	 *     (val=WebDriverVarReference name=ID param=STRING)
	 */
	protected void sequence_CheckContainsText(ISerializationContext context, CheckContainsText semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_TEXT__VAL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_TEXT__VAL));
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_TEXT__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_TEXT__NAME));
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_TEXT__PARAM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.CHECK_CONTAINS_TEXT__PARAM));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getCheckContainsTextAccess().getValWebDriverVarReferenceParserRuleCall_0_0(), semanticObject.getVal());
		feeder.accept(grammarAccess.getCheckContainsTextAccess().getNameIDTerminalRuleCall_2_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getCheckContainsTextAccess().getParamSTRINGTerminalRuleCall_4_0(), semanticObject.getParam());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     ((ref=VarReference val=WebDriverVarReference name=ID param=STRING) | (ref=VarReference val=WebDriverVarReference name=ID param=STRING))
	 */
	 ...
	 *
	 * Constraint:
	 *     (ref=VarReference val=WebDriverVarReference name=ID param=STRING)
	 */
	protected void sequence_FindFirstProperty(ISerializationContext context, WebElementVarReference semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.WEB_ELEMENT_VAR_REFERENCE__REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.WEB_ELEMENT_VAR_REFERENCE__REF));
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFindFirstPropertyAccess().getRefVarReferenceParserRuleCall_0_0(), semanticObject.getRef());
		feeder.accept(grammarAccess.getFindFirstPropertyAccess().getValWebDriverVarReferenceParserRuleCall_2_0(), semanticObject.getVal());
		feeder.accept(grammarAccess.getFindFirstPropertyAccess().getNameIDTerminalRuleCall_4_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getFindFirstPropertyAccess().getParamSTRINGTerminalRuleCall_6_0(), semanticObject.getParam());
		feeder.finish();
	}
	...
	protected void sequence_FindProperty(ISerializationContext context, FindProperty semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.FIND_PROPERTY__REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.FIND_PROPERTY__REF));
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFindPropertyAccess().getRefVarReferenceParserRuleCall_0_0(), semanticObject.getRef());
		feeder.accept(grammarAccess.getFindPropertyAccess().getValWebDriverVarReferenceParserRuleCall_2_0(), semanticObject.getVal());
		feeder.accept(grammarAccess.getFindPropertyAccess().getNameIDTerminalRuleCall_4_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getFindPropertyAccess().getParamSTRINGTerminalRuleCall_6_0(), semanticObject.getParam());
		feeder.finish();
	}
	...
	protected void sequence_FindSecondProperty(ISerializationContext context, WebElementVarReference semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFindSecondPropertyAccess().getRefVarReferenceParserRuleCall_0_0(), semanticObject.getRef());
		feeder.accept(grammarAccess.getFindSecondPropertyAccess().getValWebDriverVarReferenceParserRuleCall_2_0(), semanticObject.getVal());
		feeder.accept(grammarAccess.getFindSecondPropertyAccess().getNameIDTerminalRuleCall_4_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getFindSecondPropertyAccess().getParamSTRINGTerminalRuleCall_6_0(), semanticObject.getParam());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     ((val=WebElementVarReference param=STRING?) | ref=VarReference)
	 */
	...
	/**
	 * Contexts:
	 *     Lines returns ReadElement
	 *     FunctionCall returns ReadElement
	 *     Interractions returns ReadElement
	 *     ReadElement returns ReadElement
	 *
	 * Constraint:
	 *     (ref=VarReference val=WebElementVarReference)
	 */
	protected void sequence_ReadElement(ISerializationContext context, ReadElement semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.READ_ELEMENT__REF) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.READ_ELEMENT__REF));
			if (transientValues.isValueTransient(semanticObject, BrowserPackage.Literals.READ_ELEMENT__VAL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, BrowserPackage.Literals.READ_ELEMENT__VAL));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getReadElementAccess().getRefVarReferenceParserRuleCall_0_0(), semanticObject.getRef());
		feeder.accept(grammarAccess.getReadElementAccess().getValWebElementVarReferenceParserRuleCall_2_0(), semanticObject.getVal());
		feeder.finish();
	}
